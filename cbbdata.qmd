...
```{r simulating Duke UNC game for feb 2024, include=FALSE}
...
```
```{r conf_matrix for Duke_UNC games, echo=FALSE, message=FALSE}
...
```{r graph and conf_matrix for both teams, echo=FALSE,message=FALSE}
