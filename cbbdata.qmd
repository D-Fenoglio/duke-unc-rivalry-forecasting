...
single_game_pred %>% 
  ...
  labs(title = "100 simulations of Duke vs. UNC",
       subtitle = "Using probability 0.22895 for a Duke win",
...
This graph allows us to see the distribution of Duke and North Carolina's ACC games from the past few years, and how the model did at predicting the outcome. On the whole, it did a pretty good job, as shown by the confusion matrix analysis. Great! Then, it should be able to be just effective at predicting Duke vs. UNC, right?

# Now, let's see the past 8 years of Duke vs. UNC
